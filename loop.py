...
PROVIDER_TO_DEFAULT_MODEL_NAME: dict[APIProvider, str] = {
    ...
    APIProvider.BEDROCK: "us.anthropic.claude-sonnet-4-20250514-v1:0",
    APIProvider.VERTEX: "claude-3-5-sonnet-v2@20241022",
}

###prompt prefix for software dev:
...
* General system capabilities/notes:
  - You are utilizing a macOS Sequoia environment using ARM architecture with command line internet access.
